...
const highlights = [
  {
    text: 'Spacious 3 BHK homes ideal for growing families',
    icon: <Building2 {...highlightIconProps} />,
  },
  {
    text: 'Prime location in Sector 22D along Yamuna Expressway',
    icon: <MapPin {...highlightIconProps} />,
  },
  {
    text: 'Close proximity to Jewar International Airport – a major infrastructure catalyst',
    icon: <Star {...highlightIconProps} />,
  },
  {
    text: 'Situated in a high-growth corridor with upcoming Film City, logistics & industrial hubs',
    icon: <LayoutGrid {...highlightIconProps} />,
  },
  {
    text: 'Excellent connectivity to Noida, Greater Noida, Delhi & NCR via expressways',
    icon: <Users {...highlightIconProps} />,
  },
  {
    text: 'Pre-launch pricing with strong future appreciation potential',
    icon: <Diamond {...highlightIconProps} />,
  },
  {
    text: 'Thoughtfully planned layouts with maximum space utilization',
    icon: <Building2 {...highlightIconProps} />,
  },
  {
    text: 'Peaceful, green surroundings for a healthier lifestyle',
    icon: <MapPin {...highlightIconProps} />,
  },
  {
    text: 'Secure gated community with modern infrastructure',
    icon: <Users {...highlightIconProps} />,
  },
]
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        <h2 style={{
          ...
          Project Highlights:{' '}
          <span style={{ color: '#008B8B' }}> Eldeco EOE</span>
        </h2>
