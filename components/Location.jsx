...
const categories = [
  {
    ...
    items: ['Yamuna Expressway – 2 Mins', 'Jewar International Airport – 15 Mins', 'Pari Chowk – 20 Mins', 'Noida-Greater Noida Expressway – 30 Mins'],
  },
  {
    label: 'Education',
    ...
    items: ['Gaurs International School – 10 Mins', 'Galgotias University – 15 Mins', 'Noida International University – 20 Mins', 'DPS Greater Noida – 25 Mins'],
  },
  {
    label: 'Healthcare',
    ...
    items: ['Drona Hospital – 15 Mins', 'Kailash Hospital – 20 Mins', 'Yatharth Hospital – 25 Mins'],
  },
  {
    ...
    items: ['Starbucks – 5 Mins', 'Buddh International Circuit – 10 Mins', 'Stellar Business Park – 15 Mins', 'The Grand Venice Mall – 20 Mins'],
  },
]
    ...
    <section id="location" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>Sector 22D, Yamuna Expressway, Noida</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: '0 0 6px', letterSpacing: '-0.01em',
          }}>
            Location{' '}
            <span style={{ color: '#008B8B' }}>Advantages</span>
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              /> */}
              <Image
                src="/images/location/l-map.webp"
                alt="Eldeco Echoes Of Eden Location Map – Sector 22D, Yamuna Expressway"
                fill
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  Sector 22D, Yamuna Expressway, Noida
                </span>
              </div>
            </div>
          </div>
