...
const SHORT_TEXT = `Eldeco Echoes of Eden brings a refreshing lifestyle to the fast-growing Yamuna Expressway corridor, thoughtfully designed for young families and first-time homeowners. Located in Sector 22D, just minutes from the upcoming Jewar International Airport, this premium residential community sits at the heart of NCR's fastest-developing growth corridor, surrounded by upcoming infrastructure, business hubs, and connectivity upgrades.With seamless access to Yamuna Expressway, Noida, Greater Noida, and Delhi, along with proximity to the upcoming Film City, logistics hubs, and industrial zones, the project ensures not just convenience but a future-ready address with strong long-term value.`

const REST_TEXT = `  The project features spacious 3 BHK homes with smart layouts, ample natural light, and open green surroundings, creating a safe and nurturing environment where children can grow and families can thrive.`
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Eldeco Echoes of Eden</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: 0, letterSpacing: '-0.01em',
          }}>
            Project <span style={{ color: '#008B8B' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="Eldeco Echoes of Eden" fill className="object-cover object-center"
                ...
                <p style={{
                  ...
                  {!expanded && (
                    <button
                      ...
                      style={{
                        display: 'inline', marginLeft: '6px',
                        background: 'none', border: 'none', padding: 0,
                        color: 'var(--color-gold)', fontFamily: F_SANS,
