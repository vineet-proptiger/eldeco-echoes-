        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p className='text-justify' style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Eldeco Group is a well-established NCR-based real estate developer known for its credibility, timely delivery, and quality construction. Eldeco Group, founded in 1985, is one of the leading builders in the National Capital Region (NCR) and North India. The company has delivered over 200 projects including residential townships, high-rise apartments, industrial estates, office complexes, and malls.
            </p>
