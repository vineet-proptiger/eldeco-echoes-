            ...
            >
              {slides.map((src, idx) => (
                <div key={idx} style={{ width: `${100 / slides.length}%`, flexShrink: 0, position: 'relative' }}>
                  <Image src={src} alt={`Eldeco Echoes Of Eden ${idx + 1}`} fill className="object-cover"
          ...
          <div className="p-4 flex flex-col gap-3">
            ...
            <div style={{ textAlign: 'center', paddingBottom: '10px', borderBottom: '1px solid #f0f0f0' }}>
              ...
              <span style={{ fontSize: '1px', opacity: 0, position: 'absolute', pointerEvents: 'none', userSelect: 'none' }}>
                Eldeco Echoes of Eden New Launch Sector 22D Yamuna Expressway Greater Noida Near Jewar International Airport
              </span>
              <p style={{
            ...
            <div style={{
              ...
              {[
                'Flexible 30:40:30 Payment Plan',
                'Early Buyer Advantage – Pre-Launch Pricing Benefit',
            ...
            <div style={{ textAlign: 'center' }} data-aos="fade-up" data-aos-delay="450">
              <p style={{
                ...
                Limited Inventory Available – Book Now
              </p>
            </div>
            ...
            <div style={{
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <p style={{ fontSize: '11px', color: '#6b7280', fontFamily: F_SANS, margin: '4px 0 0' }}>Special Pre-Launch Price: ₹8,999/sq. ft.</p>
              </div>
            </div>
            ...
            <p style={{
              ...
              Hurry! Give Your Family The Space They Deserve
            </p>
